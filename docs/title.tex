\begin{titlepage}
	...
	Веб-приложение для обмена данными через локальный почтовый сервис \\}}
	...
	\begin{tabular}{p{0.52\textwidth} c c c}
		...
		\underline{\smash{Керимов~А.~Ш.}} \\[-0.6em]
		...
		Студент \underline{ ИУ7-74Б } &
		\underline{\hspace{35mm}} &
		\underline{\smash{ Новиков~М.~Р. }} \\[-0.6em]
		...
		\underline{\hspace{35mm}} &
		\underline{\smash{ Рогозин~Н.~О. }} \\[-0.6em]
